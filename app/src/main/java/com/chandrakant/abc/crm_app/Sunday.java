...
public class Sunday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      /*  listD=  new ArrayList<>();
        ...
        currentCal1.add(Calendar.DATE, 6);
        ...
        for (int i = 0; i < ListModel.getList().size(); i++) {
            ...
            if (tomorrow.contentEquals(ListModel.getList().get(i).getDate())) {
                ...
                ListModel.setList7(R.drawable.check, Name, address, "1234567890", "");

            }
        }*/


        recyclerView = (RecyclerView)v.findViewById(R.id.recycler_viewtab7);
        layoutManager=new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setHasFixedSize(true);
        adapter= new AddDataAdapter(getContext(),ListModel.getList7());
