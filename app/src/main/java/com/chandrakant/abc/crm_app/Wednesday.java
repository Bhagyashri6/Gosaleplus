    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
     ...
     /*   for (int i = 0; i < ListModel.getList().size(); i++) {
            ...
            if (tomorrow.contentEquals(ListModel.getList().get(i).getDate())) {
                ...
                ListModel.setList3(R.drawable.check, Name, address, "1234567890", "");

            }
        }*/

        recyclerView = (RecyclerView)v.findViewById(R.id.recycler_viewtab3);
        layoutManager=new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setHasFixedSize(true);
        adapter= new AddDataAdapter(getContext(),ListModel.getList3());
